 ...
 */
class EditTestIntraocularPressure extends EditTest {
    ...
    protected function createViews() {
        ...
        $this->addEditListView(Constants::VIEW_EDIT_TONOMETRY, 'Tonometry', 'Tonometry');
        $this->addEditListView(Constants::VIEW_EDIT_TONOMETRYBRALEY, 'TonometryBraley', 'TonometryBraley');
        $this->addEditListView(Constants::VIEW_EDIT_PACHYMETRY, 'Pachymetry', 'Pachymetry');
    }
}
